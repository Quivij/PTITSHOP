package com.uteshop.app.core.storage;
...
public class SessionManager {
    private static final String PREF_NAME="uteshop_session", KEY_ACCESS_TOKEN="access_token", KEY_REFRESH_TOKEN="refresh_token", KEY_USER_ID="user_id", KEY_USERNAME="username", KEY_EMAIL="email", KEY_FULL_NAME="full_name", KEY_IS_ADMIN="is_admin", KEY_XU="xu";
